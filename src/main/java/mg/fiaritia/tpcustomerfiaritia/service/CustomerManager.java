...
public class CustomerManager {
    ...
    /**
     * Récuperer la liste des Customers :
     * la requête correspond à un "select *"
     * @return List
     */
    ...
    /**
     * Fait une nouvelle insertion:
     * génèrera un INSERT SQL dans la base de données
     * @param customer 
     */
    @Transactional
